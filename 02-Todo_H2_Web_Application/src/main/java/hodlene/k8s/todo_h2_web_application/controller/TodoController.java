package hodlene.k8s.todo_h2_web_application.controller;

import hodlene.k8s.todo_h2_web_application.model.Todo;
import hodlene.k8s.todo_h2_web_application.service.TodoRepository;
